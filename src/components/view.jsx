...
export default class View extends Component {
    render () {
        return (
            <Link to={this.props.link} className="p-6 w-96 h-44 bg-gray-200 flex-grow-0 shadow-xl rounded-2xl flex transition duration-700 ease-in-out hover:bg-gray-300">
